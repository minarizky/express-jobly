...
describe('POST /users/:username/jobs/:id', () => {
  test('works for users applying for a job', async () => {
    const resp = await request(app)
  ...
  test('works for admins applying for a job on behalf of a user', async () => {
    const resp = await request(app)
  ...
  test('unauth for non-admins applying on behalf of others', async () => {
    const resp = await request(app)
  ...
  test('not found for invalid job ID', async () => {
    const resp = await request(app)
